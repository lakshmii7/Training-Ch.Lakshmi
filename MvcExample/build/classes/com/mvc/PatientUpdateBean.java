...
public class PatientUpdateBean {
	...
	public PatientRegisterBean update(int id, String name, String password, String email, String phone, String gender, String address) throws Exception {
		Connection con = ConnectionEx.Connectivity();
		String sql = "update patient set name=?,email=?,phone=?,gender=?,address=? where pid=?";
		...
		if (a != 0) {
			...
			if (rs.next()) {
				...
				prb.setPhonenumber(rs.getString("phonenumber"));
