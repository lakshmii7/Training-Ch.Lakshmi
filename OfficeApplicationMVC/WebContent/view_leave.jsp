...
<br><br>
<%@page import="com.company.ViewLeaveBean,java.util.*" %>
<table border="2" align="center" width="500" hight="300">
<tr><td>Employee Name</td><td>Email</td><td>Phone</td><td>Gender</td><td>No of days</td><td>Date of leave</td><td>Designation</td><td>Manager Name</td><td>Status</td><td>Action</td></tr>
<%
...
<tr>
			...
			<td>Accepted</td>
			<%}else{ %>
			<td><a href="./accept_leave?id=<%=lab.getid()%>&eid=<%=eid %>&no_of_days=<%=lab.getNo_of_days() %>">Accept</a></td>
			<%}%>
