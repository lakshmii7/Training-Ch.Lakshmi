<!DOCTYPE html>
<%@page import="com.company.LeaveApplyBean" %>
<html>
<body bgcolor="wheat">
	<br><br><br>
...
<a href="./index.html">logout</a>
	...
	<br><br>
<%@page import="com.company.LeaveApplyBean,java.util.*" %>
<table border="2" align="center" width="500" height="300">
<tr><td>Employee Name</td><td>Email</td><td>Phone</td><td>Gender</<td>No of days</td><td>Date of leave</td><td>Designation</td><td>Manager Name</td><td>Status</td><td>No of leave remaining</td>
		</tr>
		<%
